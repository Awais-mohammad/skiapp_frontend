...
export class ProviderHomePage extends BasicUserIdPage implements OnInit {
  ...
  openPage(selection:string) {
    ...
    switch(selection){
      ...
      case "myPackageRegistrations": {  // Reviewed;
        if(this.provider.id){
          let navigationExtras: NavigationExtras = {
            state: {
              fromCommand:this.appConstants.PAGE_FOR_MEMBER, providerId:this.provider.id
          ...
          this.router.navigate(['course-package-registrations', this.utils.getTime()], navigationExtras);
        }
        break;
      }
      case "allPackageRegistrations": {  // Reviewed;
        if(this.provider.id){
          let navigationExtras: NavigationExtras = {
            state: {
              fromCommand:this.appConstants.PAGE_FOR_PROVIDER, providerId:this.provider.id
  ...
  onViewPackages() {
    ...
    this.router.navigate(['course-packages'], navigationExtras);
  }
  ...
  async openMenu() {
    ...
    if(this.userId && this.provider.onlineMembership){
