...
export class SelectRegistrationPage extends BasicUserIdPage implements OnInit {
  ...
  selectedRegistration:PackageCourseRegistration;
  callback:any;
  ...
  ionViewWillEnter() {
    ...
    this.appSession.checkProviderContext(false, this.providerId, (context:ProviderContext) => {
      if(context){
        ...
        this.providerService.s_getCourseRegistrationsForProviderId(this.providerId, this.courseTypeId, availableOnly, true, (registrations:PackageCourseRegistration[]) => {
