...
@Component({
  selector: 'app-course-package-registration-confirm',
  templateUrl: './course-package-registration-confirm.page.html',
  styleUrls: ['./course-package-registration-confirm.page.scss'],
})
export class CoursePackageRegistrationConfirmPage extends BasicUserIdPage implements OnInit {
  ...
  updateTitle(event:any){
    ...
    this.registration.title = this.coursePackage.name + " registration for " + val;
  }
  ...
  async onConfirm() {
    ...
    this.registration.lastUpdatedDate = new Date();
