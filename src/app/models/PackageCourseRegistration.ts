...
export class PackageCourseRegistration {
  public id: number;
  public userId: number;

  // Package Registration if this.packageId is not null, otherwise this is only courseRegistration;
  public coursePackageId:number;
  public selectedPackageCourses:Course[];
...
// providerId can not be null, it's used for create skiCourse for;
  ...
  // For USS school only, should be replaced by customFields!
  public sunCardNumber:string;
