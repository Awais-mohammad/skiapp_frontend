...
export class AppConstants {
  // public INITIAL_SERVICE_URL:string = "http://localhost:4567/";

  public INITIAL_SERVICE_URL:string = "https://www.kapok-tree.com/Kapok2ServicesBeta/";
  ...
  // Encrypt key, hard coded for now;
  public CLIENT_ENCTYPT_KEY = "kapok-tree.com_230943dgfds";
  ...
  public readonly USS_PROVIDER_ID = 4; // Union de ski et snowboard
