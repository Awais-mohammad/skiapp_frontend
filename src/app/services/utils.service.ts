...
export class Utils {
  ...
  public replaceIconUrl(item: any): any {
    ...
    if (item.iconId) {
      item.iconUrl = this.appConstants.INITIAL_SERVICE_URL + serviceName + "/" + item.iconId;  // INITIAL_SERVICE_URL must ended with "/";
      item.iconFullUrl = this.appConstants.INITIAL_SERVICE_URL + serviceFullName + "/" + item.iconId;
    } else {
      item.iconUrl = this.appConstants.INITIAL_SERVICE_URL + "imageContentPreloadByName/ANONYMOUS_ICON";  // INITIAL_SERVICE_URL must ended with "/";
      item.iconFullUrl = this.appConstants.INITIAL_SERVICE_URL + "serviceFullName/ANONYMOUS_ICON";  // INITIAL_SERVICE_URL must ended with "/";
    }
    return item;
  }
