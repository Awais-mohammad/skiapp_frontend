...
export class AdminUserService {
  ...
  s_changeSiteAdmin(userId:number, isSiteAdmin:boolean, callback?){
    ...
    this.httpUtil.s_call(
      ...
      this.appConstants.INITIAL_SERVICE_URL + "adminService/changeSiteAdmin/" + userId, //urlStr,
      "post", //method,
  ...
  s_searchUsers(searchRequest:SearchUserRequest, callback?){
    ...
    this.httpUtil.s_call(
      ...
      this.appConstants.INITIAL_SERVICE_URL + "adminService/searchUsers", //urlStr,  "/adminService/searchUsers"
      "post", //method,
  ...
  s_getUserInfoById(userId:number, callback?){
    ...
    this.httpUtil.s_call(
      ...
      this.appConstants.INITIAL_SERVICE_URL + "adminService/getUserInfo/" + userId, //urlStr,
      "get", //method,
      null, //requestObj,
      null, //keyStr,
      null, //groupKeyStr,
  ...
  s_logoutUserById(userId:number, callback?){
    ...
    this.httpUtil.s_call(
      ...
      this.appConstants.INITIAL_SERVICE_URL + "adminService/logoutUser/" + userId, //urlStr,
      "post", //method,
      null, //requestObj,
      null, //keyStr,
      null, //groupKeyStr,
  ...
  s_lockUnlockUserById(userId:number, locked:boolean, callback?){
    ...
    this.httpUtil.s_call(
      ...
      this.appConstants.INITIAL_SERVICE_URL + "adminService/lockUnLockUser/" + userId + "/" + locked, //urlStr,
      "post", //method,
      null, //requestObj,
      null, //keyStr,
      null, //groupKeyStr,
  ...
  s_deleteUserById(userId:number, callback?){
    ...
    this.httpUtil.s_call(
      ...
      this.appConstants.INITIAL_SERVICE_URL + "adminService/adminDeleteUser/" + userId, //urlStr,
      "post", //method,
      null, //requestObj,
      null, //keyStr,
      null, //groupKeyStr,
  ...
  s_deleteUsersByIds(userIds:number[], callback?){
    ...
    this.httpUtil.s_call(
      ...
      this.appConstants.INITIAL_SERVICE_URL + "adminService/deleteUsersByIds", //urlStr,
      "post", //method,
      userIds, //requestObj,
      null, //keyStr,
      null, //groupKeyStr,
