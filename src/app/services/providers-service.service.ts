...
export class ProvidersService {
  ...
  s_registerSkiRegistration(userId:number, registration:PackageCourseRegistration, callback?) {
    if(!registration){
      if(callback){
        callback(null);
      }
  ...
  s_getRegistrationsByCourseId(userId:number, courseId:number, callback?) {
    ...
    this.aclService.s_getURL( (serviceUrl:string) => {
      this.httpUtil.s_call(
        ...
        null, //groupKeyStr,
        null, //ttl,
        (registrations:PackageCourseRegistration[]) => {
          if(callback){
  ...
  s_getCourseRegistrationsForProviderId(providerId:number, courseTypeId:number, available:boolean, futureOnly:boolean, callback?) {
    ...
    this.aclService.s_getURL( (serviceUrl:string) => {
      ...
      this.httpUtil.s_call(
        ...
        null, //groupKeyStr,
        null, //ttl,
        (regs:PackageCourseRegistration[]) => {
          if(callback){
            callback(regs);
          }
        }
  ...
  getDefaultCourseAgeOptions(callback?) {
    console.log("getDefaultCourseAgeOptions.");
    this.aclService.s_getURL( (serviceUrl:string) => {
      let url = serviceUrl + "getDefaultCourseAgeOptions";
      this.httpUtil.s_call(
        "getDefaultCourseAgeOptions",  // objName
        url, //urlStr,
        "get", //method,
        null, //requestObj,
        null, //keyStr,
  ...
  getDefaultCourseLevelOptions(callback?) {
    console.log("getDefaultCourseLevelOptions.");
    this.aclService.s_getURL( (serviceUrl:string) => {
      let url = serviceUrl + "getDefaultCourseLevelOptions";
      this.httpUtil.s_call(
        "getDefaultCourseLevelOptions",  // objName
        url, //urlStr,
        "get", //method,
        null, //requestObj,
        null, //keyStr,
